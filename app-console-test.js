...
(async () => {
  ...
  console.log(`Total length: ${totalUsers}`);
  ...
  registeredUsers.forEach(user => {
    ...
    if(ticketsPaidByuser > 1){
      console.log(`Tickets Paid for: ${ticketsPaidByuser}`);
  ...
  for (const city in cityCounts) {
    console.log(`${city}: ${cityCounts[city]} registrations`);
  }
  console.log(`Arm Wrestling: ${armWrestlingCount} registrations`);

  // Total users count
  console.log(`Total Registrations: ${totalUsers}`);
